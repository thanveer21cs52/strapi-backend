...
export interface ApiBgimgBgimg extends Struct.SingleTypeSchema {
  collectionName: 'bgimgs';
  info: {
    displayName: 'bgimg';
    pluralName: 'bgimgs';
    singularName: 'bgimg';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::bgimg.bgimg'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactbanner1: Schema.Attribute.Component<'contact.contactbanner1', false>;
    contactbanner2: Schema.Attribute.Component<'contact.contactbanner2', true>;
    contactbanner3: Schema.Attribute.Component<'contact.contactbanner3', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    banner1: Schema.Attribute.Component<'homepage.homebanner1', false>;
    banner2: Schema.Attribute.Component<'homepage.homebanner2', false>;
    banner3: Schema.Attribute.Component<'homepage.homebanner3', true>;
    banner4: Schema.Attribute.Component<'homepage.homebanner4', false>;
...
export interface ApiJobJob extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    jobbanner1: Schema.Attribute.Component<'job.jobbanner1', true>;
    jobbanner2: Schema.Attribute.Component<'job.jobbanner2', false>;
    jobbanner3: Schema.Attribute.Component<'job.jobbanner3', false>;
    jobbanner4: Schema.Attribute.Component<'job.jobbanner4', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNewNew extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::new.new'> &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Component<'img.img', false>;
    navlist: Schema.Attribute.Component<'nav.nav-list', false>;
    publishedAt: Schema.Attribute.DateTime;
    social: Schema.Attribute.Component<'nav.social', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
